        ...
        <section class="wrapper">
            ...
            <div class="table-responsive">
                ...
                <table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
                    ...
                    $query = mysqli_query($conn, "SELECT * FROM `teacher_reg` JOIN deparment ON deparment.dep_id = teacher_reg.t_department JOIN course ON course.c_id = teacher_reg.t_course
") or die(mysqli_error());
                    ...
                    <tr>
                        ...
                        <td><?php echo $row['t_address'] . ',' . $row['t_city'] . ',' . $row['t_state']; ?></td>
                        ...
                        <td><input type="checkbox" data-toggle="toggle" data-on="Active" data-off="Deactive"
                                   ...
                                   onchange="status_change(this.value);" value="<?php echo $row['t_id']; ?>"
...
<script>
    ...
    function status_change(teacher_id) {
        //alert(teacher_id);
        // alert(sid);
        $.ajax({
            //alert(photographer_id);
            type: "POST",
            url: "teacher_status_change.php",
