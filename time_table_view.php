...
<section id="container">
    ...
    <section id="main-content">
        ...
        <section class="wrapper">
            <a class="btn btn-success btn-print" href="" onclick="window.print()"
               style="margin-bottom: 1%;margin-left: 90% ;"><i
            ...
            <div class="table-agile-info">
                <div class="panel panel-default">
                    ...
                    <br><?php $s_id = $_GET['s_id'];
                    $sql6 = "SELECT * FROM sem where s_id=$s_id";
                    $result6 = mysqli_query($conn, $sql6);
                    while ($row6 = mysqli_fetch_array($result6, MYSQLI_ASSOC)) {
                        ?>
                        <center><h3><?php
                                $c_id = $row6['c_id'];
                                $sql7 = "SELECT * FROM course where c_id=$c_id";
                                $result7 = mysqli_query($conn, $sql7);
                                while ($row7 = mysqli_fetch_array($result7, MYSQLI_ASSOC)) {
                                    echo $row7['c_name'] . ' - ' . $row6['s_name'];
                    ...
                    <div class="table-responsive">
                        <table class="table" border="2px;">
                            ...
                            <tr>
                                ...
                                $tid7 = '';
                                $s_id = $_GET['s_id'];
                                $sql3 = "SELECT * FROM time_table where sem_id=$s_id";
                                ...
                                <td><?php
                                    ...
                                    $q2 = "SELECT * FROM subject where sub_id='$a'";
