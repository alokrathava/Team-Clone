...
<section id="container">
    ...
    if (isset($_GET['delete'])) {
        ...
        $select_query = "delete from sem subject s_id=$s_id";
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <div class="position-center">
                        <form role="form" method="post" action="sub_process.php">
                            <?php
                            include('config.php');
                            ...
                            <div class="ggg">
                                ...
                                <select name="c_id" class="form-control" id="state">
                            ...
                            <div class="ggg">
                                ...
                                <select name="sem_id" class="form-control" id="city">
                                    <option value="">Select Department</option>
                                </select>
                            ...
                            <div class="form-group">
                                <label for="courseid">Enter Subject</label>
                                <input type="text" name="sub_name" class="form-control" id="semid"
